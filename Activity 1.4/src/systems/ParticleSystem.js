...
export class ParticleSystem {
    ...
    createSettlingParticles(material, beakerObject, waterLevel) {
        const particleCount = material.particleCount;
        // Use 0 detail Icosahedron for a more granular, faceted look
        const geometry = new THREE.IcosahedronGeometry(material.particleSize, 0);
        ...
        for (let i = 0; i < particleCount; i++) {
            // Add slight variation to sand color
        ...
        // Spawn particles in a small area above beaker, they will spread when settling
        const spawnRadius = 1.0; // Small spawn area
